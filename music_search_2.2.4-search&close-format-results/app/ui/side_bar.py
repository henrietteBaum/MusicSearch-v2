...
class SideBar(QDockWidget):
    ...
    def _build_ui(self):
        ...
        layout.addWidget(self.limit_label, 3, 0)
        layout.addWidget(self.limit_input, 4, 0)
        
        layout.addWidget(QFrame(frameShape=QFrame.HLine), 5, 0)

        layout.addWidget(self.history_label, 6, 0)
        layout.addWidget(self.history_list, 7, 0)
