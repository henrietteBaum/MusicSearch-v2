...
class MainWindow(QMainWindow):
    ...
    def _connect_signals(self):
        ...
        self.menu_bar.zoom_in_requested.connect(self.zoom_in)
        self.menu_bar.zoom_out_requested.connect(self.zoom_out)
        self.menu_bar.reset_zoom_requested.connect(self.reset_zoom)
