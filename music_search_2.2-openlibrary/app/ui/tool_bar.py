...
class ToolBar(QToolBar):
    ...
    def _build_toolbar(self):
        ...
        self.search_action = QAction(self.search_icon, "Music-Search", self)
        self.search_action.setShortcut("Ctrl+Return")

        self.library_icon = QIcon.fromTheme("view-media-lyrics-symbolic")
        self.library_action = QAction(self.library_icon, "Library-Search", self)
        self.library_action.setShortcut("Ctrl+l")
        ...
        self.addAction(self.library_action)
        self.addSeparator()
